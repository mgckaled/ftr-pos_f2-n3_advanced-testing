...
describe("MedicalRecord Value Object", () => {
  ...
  describe("Método addDiagnosis", () => {
    ...
    it("deve lançar erro ao adicionar objeto inválido", () => {
      ...
      expect(() => record.addDiagnosis(invalidDiagnosis)).to.throw("Invalid diagnosis object.")
    })
  })
  ...
  describe("Método addMedication", () => {
    ...
    it("deve lançar erro ao adicionar objeto inválido", () => {
      ...
      expect(() => record.addMedication(invalidMedication)).to.throw("Invalid medication object.")
    })
  })
  ...
  describe("Método addTreatment", () => {
    ...
    it("deve lançar erro ao adicionar objeto inválido", () => {
      ...
      expect(() => record.addTreatment(invalidTreatment)).to.throw("Invalid treatment object.")
    })
  })
  ...
  describe("Método getActiveTreatments", () => {
    it("deve retornar apenas tratamentos ativos", () => {
      ...
      const activeTreatment = new Treatment("Fisioterapia", new Date(), futureDate)
      const inactiveTreatment = new Treatment("Quimioterapia", new Date("2023-01-01"), pastDate)
